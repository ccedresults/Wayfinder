CREATE TABLE [RAW].[K12_StudentEnrollment2012]
(
[RAW_K12_StudentEnrollment2012ID] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [RAW].[K12_StudentEnrollment2012] ADD CONSTRAINT [pk_RAW_K12_StudentEnrollment2012ID] PRIMARY KEY CLUSTERED  ([RAW_K12_StudentEnrollment2012ID]) ON [PRIMARY]
GO
